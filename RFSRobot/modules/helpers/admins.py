...
from RFSRobot.modules.helpers.interval import IntervalHelper
import RFSRobot.modules.cache.admins

async def get_administrators(chat: Chat) -> List[User]:
    get = RFSRobot.modules.cache.admins.get(chat.id)
    ...
    if get:
        ...
        RFSRobot.modules.cache.admins.set(chat.id, to_set)
