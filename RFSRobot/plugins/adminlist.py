...
from RFSRobot.modules.helpers.parser import mention_html, mention_markdown



@Client.on_message(command(["admins", "adminlist"]) & rfs_filters)
...
@Client.on_message(command(["kickdel", "zombies"]) & rfs_filters)
...
@Client.on_message(command(["reportadmin", "reportadmins", "report"]) & rfs_filters)
...
@Client.on_message(command(["everyone", "tagall"]) & rfs_filters)
...
@Client.on_message(command(["botlist", "bots"]) & rfs_filters)
