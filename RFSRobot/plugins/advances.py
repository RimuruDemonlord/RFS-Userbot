# Copyright © By @RimuruDemonlord // @AdityaHalder
import asyncio
...
Kaal = f"**꧁ 𒈞RFS υѕєявσт𒈞꧂**\n\n"
Kaal += f"━───────╯•╰───────━\n"
Kaal += f"➠ **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `5.0 beta`\n"
Kaal += f"➠ **ᴘʏʀᴏɢʀᴀᴍ ᴠᴇʀsɪᴏɴ** : `{__version__}`\n"
Kaal += f"➠ **ᴠᴇʀsɪᴏɴ**  : `{2.0}`\n"
Kaal += f"➠ **Group** : [❝𝐂𝐥𝐢𝐜𝐤❞](https://t.me/RFS_Support)\n"
Kaal += f"━───────╮•╭───────━\n\n"
Kaal += f"➠ **𒆜ʍǟӄɛ ʏօʊʀ օառ 𒆜:** [❝𝐂𝐥𝐢𝐜𝐤❞](https://gitHub.com/RimuruDemonlord/RFS-Userbot)"
